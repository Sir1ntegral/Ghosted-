...
HELP: dict[str, list[tuple[str, str, str]]] = {
    "Ghost (stealth)": [
        ("recon <topic>", "stealth-investigate a topic",
        ...
        ("browse <query>", "sovereign web search",
        ...
        ("cloak <img> <msg>", "hide an encrypted message in an image (stego)",
